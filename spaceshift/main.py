...
class Star(pygame.sprite.Sprite):
    def __init__(self, groups ):
        super().__init__(groups)
        self.image = pygame.image.load(join('spaceshift','images', 'star.png')).convert_alpha()
...
for i in range (20):
    ...
    star.rect.center = (randrange(0, WIDTH), randrange(0, HEIGHT))
    stars.append(star)
...
while not exit:
    ...
    """ for star in stars:
        display_surface.blit(star.image, star.rect)#putting one surface on another surface
     """
